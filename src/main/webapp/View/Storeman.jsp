...
<div class="storeman-div">
    <div class="add-game">
        <form enctype="multipart/form-data" action="GameServlet" method="POST">
            ...
            <input class="input"  type="text" name="game-name" placeholder="Inserisci il nome del gioco" >
            <input class="input" type="text" name="game-price" placeholder="Inserisci il prezzo del gioco">
            <input class="input" type="text" name="game-date" placeholder="Inserisci la data (YYYY-MM-DD)">
            ...
            <div class="a">
                ...
                <input class="input" id="image-loader" name="game-image" type="file">
            </div>

            <div class="a">
                <label for="game-landscape">Sfondo</label>
                <input class="input" id="landscape-loader" name="game-landscape" type="file">
            </div>
    ...
    <div class="admin-game-cont">
        <div class="remove-game">
            <form action="GameServlet" method="POST">
                <h2>Elimina gioco</h2>
                <input class="input" id="delete-game-id" placeholder="Inserisci l'ID del gioco" style="margin-bottom: 10px;">
        ...
        <div class="update-game">
            <form action="GameServlet" method="POST">
                ...
                <input class="input" id="update-game-id" type="text" placeholder="Inserisci l'ID del gioco" style="margin-bottom: 10px;" required>
                <input class="input" id="update-game-price" type="text" placeholder="Inserisci il nuovo prezzo" style="margin-bottom: 10px;" required>
